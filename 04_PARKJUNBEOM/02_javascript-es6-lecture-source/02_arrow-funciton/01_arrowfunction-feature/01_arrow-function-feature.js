...
class Tiger extends Animal {
  move(lostWeight) {
    // 일반함수
    // setTimeout(function () {
    //   super.move(lostWeight); // SyntaxError: 'super' keyword unexpected here
    // }, 3000);
    // 화살표 함수
    setTimeout(() => {
...
// 화살표 함수는 콜백 함수로 자주 사용되며, 자신의 this/arguemnts를 갖지 않고
// 상위스코프를 그대로 참조하도록 설계되어 ES5 콜백함수에서 자주 발생하던
